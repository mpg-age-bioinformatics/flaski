...
def update_output(n_clicks,rows_atac,rows_input,email,group,folder,md5sums,project_title,organism,ercc,seq, adapter,macs2,mito,wget ):
    ...
    if user_domain == "age.mpg.de" :
        ...
        ftp_user=send_submission_ftp_email(user=current_user, submission_type="ChIPseq", submission_tag=subdic["filename"], submission_file=None, attachment_path=subdic["filename"])
