...
dashapp = dash.Dash("tsne",url_base_pathname=f'{PAGE_PREFIX}/tsne/', meta_tags=META_TAGS, server=app, external_stylesheets=[dbc.themes.BOOTSTRAP, FONT_AWESOME], title="t-SNE", assets_folder=app.config["APP_ASSETS"])# , assets_folder="/flaski/flaski/static/dash/")
