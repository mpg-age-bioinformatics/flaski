...
dashapp = dash.Dash("dendrogram",url_base_pathname=f'{PAGE_PREFIX}/dendrogram/', meta_tags=META_TAGS, server=app, external_stylesheets=[dbc.themes.BOOTSTRAP, FONT_AWESOME], title="Dendrogram" , assets_folder=app.config["APP_ASSETS"])# , assets_folder="/flaski/flaski/static/dash/")
