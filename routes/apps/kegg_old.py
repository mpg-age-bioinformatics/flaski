...
dashapp = dash.Dash("kegg_old",url_base_pathname=f'{PAGE_PREFIX}/kegg_old/', meta_tags=META_TAGS, server=app, external_stylesheets=[dbc.themes.BOOTSTRAP, FONT_AWESOME], title="KEGG OLD", assets_folder=app.config["APP_ASSETS"])# , assets_folder="/flaski/flaski/static/dash/")
