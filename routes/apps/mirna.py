...
dashapp = dash.Dash("mirna",url_base_pathname=f'{PAGE_PREFIX}/mirna/', meta_tags=META_TAGS, server=app, external_stylesheets=[dbc.themes.BOOTSTRAP, FONT_AWESOME], title="miRNA", assets_folder=app.config["APP_ASSETS"])# , assets_folder="/flaski/flaski/static/dash/")
