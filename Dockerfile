...
RUN apt-get update && apt-get install -yq python3-markdown libgirepository1.0-dev libcairo2-dev python3-dev pkg-config ninja-build build-essential gobject-introspection gcc libglib2.0-dev && \
